        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description"> List of <code>Archived Administrators</code></p>
                    ...
                    <table class="table table-striped" id="archive_table">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='6' class='text-center'>No Archive administrators found.</td></tr>";
                            }
    ...
    <div class="modal fade" id="archiveModal" tabindex="-1" aria-labelledby="archiveModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="archiveForm" method="post" action="process/unarchive.php">
                    <div class="modal-header">
                        <h5 class="modal-title" id="archiveModalLabel">Restore Administrator</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to restore this administrator?</p>
