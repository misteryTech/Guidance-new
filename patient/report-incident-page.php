            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="form-select" name="counselor_id">
                        ...
                        <?php
                        if ($result_counselor && mysqli_num_rows($result_counselor) > 0) {
                            while ($row = mysqli_fetch_assoc($result_counselor)) {
                                echo '<option value="' . htmlspecialchars($row['Counselor_Id']) . '">' . htmlspecialchars($row['FirstName'] . ' ' . $row['LastName']) . '</option>';
                            }
                        } else {
