<div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10 d-flex flex-wrap gap-3">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input" id="grooming-excellent" name="grooming" value="excellent" required>
                                                        ...
                                                        <div class="form-group row">
                                                              <h6>Posture</h6>
                                                              <div class="col-sm-12 d-flex flex-wrap gap-3">
                                                                  <div class="form-check">
                                                                      <input type="radio" class="form-check-input" id="posture-excellent" name="posture" value="excellent" required> 
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12 d-flex flex-wrap gap-3">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input" id="seriousness-excellent" name="seriousness" value="excellent" required>
                                                          ...
                                                          <div class="form-group row">
                                                              ...
                                                              <div class="col-sm-12 d-flex flex-wrap gap-3">
                                                                  <div class="form-check">
                                                                      <input type="radio" class="form-check-input" id="academic-ability-excellent" name="academic_ability" value="excellent" required>
                                                          ...
                                                          <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12 d-flex flex-wrap gap-3">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input" id="academic-achievement-excellent" name="academic_achievement" value="excellent" required>
